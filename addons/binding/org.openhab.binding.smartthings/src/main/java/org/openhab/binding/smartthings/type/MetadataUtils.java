/***Copyright(c)2014-2015 openHAB UG(haftungsbeschraenkt)and others.**All rights reserved.This program and the accompanying materials*are made available under the terms of the Eclipse Public License v1.0*which accompanies this distribution,and is available at*http://www.eclipse.org/legal/epl-v10.html
*/
...
public class MetadataUtils {
     ...
     */
    public static String getLabel(Device dp) {
     ...
     */
    public static String getDatapointDescription(Device dp) {
        return dp.getDisplayName();
    }
    ...
    public static Map<String, String> mapCapabilityToChannelTypes(Capability capability) {
        Map<String, String> map = new HashMap<>();
        if (capability.getName().equals("Switch")) {
            map.put(ITEM_TYPE_SWITCH, capability.getName());
        }
        if (capability.getName().equals("Switch Level")) {
            map.put(ITEM_TYPE_DIMMER, capability.getName());
        }
        return map;
    }

    public static String getItemType(Device dp) {

        if (dp.getCapabilityMap().containsKey("Switch Level")) {
            return ITEM_TYPE_DIMMER;
        }
        if (dp.getCapabilityMap().containsKey("Switch")) {
     ...
     */
    public static String getCategory(Device dp, String itemType) {
        // String dpName = dp.getName();
        // String channelType = StringUtils.defaultString(dp.getChannel().getType());
        //
