...
import org.openhab.binding.smartthings.client.auth.ApiKeyAuth;
import org.openhab.binding.smartthings.client.auth.HttpBasicAuth;
import org.openhab.binding.smartthings.client.auth.OAuth;
import org.openhab.binding.smartthings.client.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public ApiClient(String[] authNames) {
        ...
        for (String authName : authNames) {
            ...
            if (authName == "code_oauth") {
                auth = new OAuth(OAuthFlow.accessCode, "https://api.netatmo.net/oauth2/authorize",
                        "https://api.netatmo.net/oauth2/token", "read_station, write_thermostat, read_thermostat");
            } else if (authName == "password_oauth") {
    ...
    public void createDefaultAdapter() {
        ...
        adapterBuilder = new Retrofit.Builder().baseUrl("https://api.netatmo.net/api")
